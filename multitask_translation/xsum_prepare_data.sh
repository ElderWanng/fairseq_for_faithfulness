...
python data/extract_raw_xsum.py  --dataset_name xsum --neg_csv $NEG_CSV --pos_out_dir $DATA/pos_raw --neg_out_dir $DATA/neg_raw --keep_neg 0.5 --text_column document --summary_column summary
